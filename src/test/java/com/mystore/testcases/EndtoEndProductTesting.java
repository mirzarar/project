...
public class EndtoEndProductTesting extends BaseClass {
...
Brands.brand1();
String actualURLbrands=Store.getCurrURL();
String brandsURL="https://app.getapimio.com/products/brands";
Log.info("Verifying if user is able to add brand 1sts");
...
Cat.categories1();
String actualURLcategories=Store.getCurrURL();
